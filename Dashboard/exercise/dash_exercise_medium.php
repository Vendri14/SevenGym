                ...
                <div class="table-responsive">
                    ...
                    <a href="dash_exercise.php"><button style="border-right:0;" id="pilih">Exercise Paket </button></a> <a href="dash_exercise2.php"><button style="border-left: 0;" id="pilih2">Exercise User</button></a>
                        ...
                        <button onclick="openModal(myModal)" class="btntambah"><img src="../img/Vector.png"
                                    ...
                                    <br>
                                    <a href="dash_exercise.php"><button style="" id="beginner">Beginner</button></a> <button style="" id="medium">Medium <a href="dash_exercise_expert.php"><button style="" id="expert">Expert</button></a>
                        ...
                        <tbody>
                            <?php
                            $query_sql = "select exercise.nama_exercise,detail_paket_exercise.id_paket_exc , detail_paket_exercise.waktu_set,detail_paket_exercise.repetisi from exercise join detail_paket_exercise on exercise.id_exercise = detail_paket_exercise.id_exercise where detail_paket_exercise.id_paket = 2";
                            $sql= mysqli_query($koneksi, $query_sql);
                            $no = 1;
                            ?>
                            <?php
